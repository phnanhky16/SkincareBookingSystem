    ...
    >
      <div className='wrapper'>
        <div className='discount-info'>
          ...
          <h2>BamboSpa develops its own brands</h2>
          <p>
            The BamboSpa network is being developed and improved, taking into
          ...
          <p className='discount-info__sm'>
            ...
            and care. BamboSpa stores offer their customers the widest and
